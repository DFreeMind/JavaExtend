package com.weduoo.javaExtend.proxy_test;
...
public class ProxyPerson {
	...
	public static void main(String[] args) {
		...
		// 创建一个MyPerson的代理对象
		PersonInterface proxy = (PersonInterface) Proxy.newProxyInstance(MyPerson.class.getClassLoader(), p.getClass().getInterfaces(), new InvocationHandler() {
